...
import com.android.youtubesearch.adapters.YoutubeTapAdapter
import com.android.youtubesearch.models.ResponseModel
import com.android.youtubesearch.models.VideoModel
import com.example.myapplication.models.ErrorModel
import com.example.myapplication.network.ApiClient
import com.example.myapplication.network.ApiClient.API_KEY
...
class MainFragmentYouTube : Fragment(R.layout.fragment_home) {

    private lateinit var mConstraintLayoutHome: ConstraintLayout
    private lateinit var mRecyclerViewHome: RecyclerView

    private lateinit var mYoutubeTapAdapter: YoutubeTapAdapter
    ...
    fun setAdapter(mSearchaVideosList: ArrayList<VideoModel>) {
        context?.let {
            mYoutubeTapAdapter = YoutubeTapAdapter(
                it,
                mSearchaVideosList
            )
            mYoutubeTapAdapter.notifyDataSetChanged()
            mRecyclerViewHome.adapter = mYoutubeTapAdapter
        }
    }
